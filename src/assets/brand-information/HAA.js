const HAAConfig = {
  ...
  productLines: ['Blends'], // , 'Monoflorals' removed
  ...
  brandRoutes: ['HAA/Blends'], // , 'HAA/Monoflorals' removed
  brandProductLines: {
    "Blends": {
      name: "Blends",
      urlSlug: "blends",
